/* 
	...
	Hardware: ESP32 Family Device (esp32_esp32_family), Platform=esp32, Package=esp32
*/
...
#define ARDUINO_ESP32_FAMILY 1
#define ARDUINO_ARCH_ESP32 1
#define ARDUINO_BOARD "ESP32_FAMILY"
#define ARDUINO_VARIANT "{build.variant}"
